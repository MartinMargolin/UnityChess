...
public class GameManager : MonoBehaviourSingleton<GameManager> {
	...
	public static event Action NewGame960StartedEvent;
...
#if AI_TEST
	public async void StartNew960Game(bool isWhiteAI = true, bool isBlackAI = true) {
#else
    public async void StartNew960Game(bool isWhiteAI = false, bool isBlackAI = false)
    {
#endif
		Board testBoard = new Board();
		testBoard.WriteNew960Board();
